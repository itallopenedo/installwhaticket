...
frontend_node_dependencies() {
  print_banner
  printf "${WHITE} 💻 Installing dependencies frontend...${GRAY_LIGHT}"
  printf "\n\n"
...
frontend_node_build() {
  print_banner
  printf "${WHITE} 💻 Compiling the code frontend...${GRAY_LIGHT}"
  printf "\n\n"
...
frontend_start_pm2() {
  print_banner
  printf "${WHITE} 💻 Starting pm2 (frontend)...${GRAY_LIGHT}"
  printf "\n\n"
